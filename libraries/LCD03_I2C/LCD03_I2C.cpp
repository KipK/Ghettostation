...
LCD03_I2C::LCD03_I2C(int address)
{
    //I2C_Init();
    _address = address;
...
void LCD03_I2C::begin(uint8_t cols_max, uint8_t rows_max) {
    _cols_max = cols_max;
    _rows_max = rows_max;
    I2C_Init();
...
void LCD03_I2C::setCursor(byte col, byte row) 
{
...
void LCD03_I2C::print(const char *s) 
{
  while (*s) {
    PrintVal(*s++);
  }
